    ...
    <div className="flex-1 flex flex-col bg-bg-dark overflow-y-auto custom-scrollbar">
      <div className="p-6 border-b border-border-main bg-bg-panel/50">
        <div className="flex items-center gap-2 text-xs text-slate-500 mb-1 font-mono uppercase tracking-widest">
          <Shield className="w-3 h-3" /> Governance & Rules
        </div>
        <h2 className="text-2xl font-bold text-white font-mono tracking-tight">System Policies</h2>
      </div>
      ...
      <div className="p-6 space-y-6">
        <div className="bg-accent-blue/5 border border-accent-blue/20 p-4 rounded-sm flex gap-4 items-start">
          ...
          <div>
            <h4 className="text-sm font-bold text-white mb-1">Policy Enforcement Active</h4>
          ...
          {policies.map((policy) => (
            <div key={policy.id} className="bg-bg-panel border border-border-main rounded-sm p-5 hover:border-slate-600 transition-colors group">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="text-[10px] font-mono text-slate-500">{policy.id}</span>
              ...
              <div className="flex justify-end gap-2 mt-4 pt-4 border-t border-border-main/50">
                <button className="px-3 py-1.5 text-[10px] font-bold text-slate-400 hover:text-white transition-colors uppercase tracking-wider">View Logs</button>
                <button className="px-3 py-1.5 text-[10px] font-bold text-accent-blue hover:text-blue-400 transition-colors uppercase tracking-wider">Edit Policy</button>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
          <div className="bg-bg-panel border border-border-main rounded-sm p-6">
            <h3 className="text-sm font-bold text-white uppercase tracking-wider mb-4 flex items-center gap-2">
              <Lock className="w-4 h-4 text-accent-blue" /> Access Control
            </h3>
            <div className="space-y-3">
              <div className="flex justify-between items-center p-3 bg-bg-dark/50 rounded border border-border-main/50">
                <span className="text-xs text-slate-300">RBAC Enforcement</span>
                <span className="text-[10px] font-bold text-green-400">ENABLED</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-bg-dark/50 rounded border border-border-main/50">
                <span className="text-xs text-slate-300">Audit Logging</span>
                <span className="text-[10px] font-bold text-green-400">ENABLED</span>
              </div>
            </div>
          </div>
          <div className="bg-bg-panel border border-border-main rounded-sm p-6">
            <h3 className="text-sm font-bold text-white uppercase tracking-wider mb-4 flex items-center gap-2">
              <Eye className="w-4 h-4 text-accent-blue" /> Compliance Overview
            </h3>
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-xs text-slate-300 font-bold">System Compliance</p>
                <p className="text-[10px] text-slate-500 mt-1">2 nodes currently in violation of POL-001.</p>
              </div>
            </div>
          </div>
        </div>
