    ...
    <main className="flex flex-1 overflow-hidden relative bg-bg-dark">
      <section className="flex-[2] flex flex-col border-r border-border-main h-full min-w-0">
        <div className="flex justify-between items-center px-6 py-4 border-b border-border-main bg-[#0F1512]">
          <div className="flex items-center gap-3">
            <h2 className="text-sm font-semibold uppercase tracking-wider text-accent-green flex items-center gap-2">
              <Terminal className="w-4 h-4" />
              Bulk URL Entry
            </h2>
          </div>
          <div className="flex items-center gap-3">
            <span className="text-xs text-slate-500">Paste GitHub URLs (one per line)</span>
            <button className="text-slate-400 hover:text-white"><Copy className="w-4 h-4" /></button>
            <button onClick={() => setUrls('')} className="text-slate-400 hover:text-white"><Trash2 className="w-4 h-4" /></button>
          </div>
        </div>
        ...
        <div className="flex-1 relative flex flex-col bg-[#0D1310]">
          <div className="flex items-center gap-1 px-4 bg-[#16201A] border-b border-border-main">
            <div className="px-4 py-2 bg-[#0D1310] border-t-2 border-t-accent-green text-xs text-white font-mono flex items-center gap-2">
              urls.txt
            </div>
          </div>
          <div className="flex flex-1 overflow-hidden relative">
            <div className="py-4 pl-4 font-mono text-sm bg-[#111613] text-slate-600 select-none w-12 shrink-0 h-full flex flex-col items-end border-r border-border-main">
          ...
          <div className="p-4 border-t border-border-main bg-[#111814] flex justify-between items-center">
            ...
            <div className="flex gap-3">
              <button 
                ...
                className="bg-accent-green hover:bg-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed text-black text-sm font-bold py-2 px-6 rounded-md transition-colors shadow-[0_0_15px_rgba(16,185,129,0.3)] flex items-center gap-2"
              >
      ...
      <section className="flex-1 flex flex-col h-full bg-bg-panel min-w-[320px]">
        <div className="px-5 py-4 border-b border-border-main flex justify-between items-center bg-[#16201A]">
          ...
          <span className="text-[10px] bg-[#1F2923] text-slate-400 px-2 py-0.5 rounded-full border border-border-main font-mono">
            ...
            <div key={idx} className={`bg-[#0A0F0D] border rounded-lg p-4 relative overflow-hidden group shadow-lg transition-all ${
              ...
              <div className="flex justify-between items-start mb-3 relative z-10">
                <div className="flex flex-col gap-0.5">
                  ...
                  <h4 className="font-bold text-sm text-white tracking-tight">{item.id}</h4>
                </div>
                {item.status === 'COMPLETE' ? (
                  ...
                  <div className="flex items-center gap-1 text-accent-green bg-[#14532D]/30 px-2 py-0.5 rounded text-[10px] font-bold border border-[#14532D]">
        ...
        <div className="p-3 bg-[#111814] border-t border-border-main text-[10px] text-center text-slate-600 font-mono">
