          ...
          <div className="flex items-start justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white leading-tight flex items-center gap-3">
                  {repo.id}
                  <span className="px-2.5 py-0.5 bg-green-500/10 text-green-400 text-[11px] font-medium rounded-full border border-green-500/20 uppercase tracking-wide">Active</span>
                </h1>
                <div className="flex items-center gap-4 mt-2 text-sm">
                  ...
                  <span className={`flex items-center gap-1 px-2 py-0.5 rounded border text-[11px] font-medium ${getLicenseColor(repo.license)}`}>
                    <ShieldCheck className="w-3.5 h-3.5" /> {repo.license} License
                  </span>
                </div>
              </div>
            </div>
            <div className="flex items-center gap-6">
              <div className="text-right">
                <div className="text-3xl font-bold text-accent-blue font-mono tracking-tight">{repo.score}<span className="text-lg text-slate-500 font-normal">/100</span></div>
                <div className="text-[10px] text-slate-500 uppercase tracking-wider font-semibold">Health Score</div>
              </div>
        ...
        <div className="lg:col-span-8 space-y-6">
          <section className="bg-bg-panel rounded-xl border border-border-main p-6 shadow-sm relative overflow-hidden">
            <div className="flex items-center justify-between mb-4 relative z-10">
              ...
              <span className="text-[10px] bg-purple-500/10 text-purple-400 px-2 py-1 rounded-full border border-purple-500/20 font-medium">Model: Gemini 3 Flash</span>
            </div>
            <p className="text-slate-300 leading-relaxed text-[15px] mb-6">
              {repo.description || "No description available for this repository."}
            </p>
            <div className="flex flex-wrap gap-2">
              <span className="px-3 py-1 bg-blue-500/10 text-blue-400 text-[11px] font-bold rounded-md border border-blue-500/20">FRONTEND</span>
              <span className="px-3 py-1 bg-blue-500/10 text-blue-400 text-[11px] font-bold rounded-md border border-blue-500/20">JAVASCRIPT</span>
              <span className="px-3 py-1 bg-blue-500/10 text-blue-400 text-[11px] font-bold rounded-md border border-blue-500/20">LIBRARY</span>
            </div>
          </section>
          ...
          {repo.readme && (
            <section className="bg-bg-panel rounded-xl border border-border-main p-6 shadow-sm">
              ...
              <div className="prose prose-invert max-w-none text-sm text-slate-400 line-clamp-[10] overflow-hidden relative">
                <div className="whitespace-pre-wrap font-mono text-[12px] bg-bg-dark/50 p-4 rounded-lg border border-border-main/50">
                ...
                {repo.readme.length > 2000 && (
                  <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-bg-panel to-transparent flex items-end justify-center pb-2">
                    <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Truncated for preview</span>
                  </div>
                )}
              </div>
            </section>
              ...
              <div className="space-y-3">
                <div className="p-3 bg-bg-dark rounded-lg border border-border-main">
                  <div className="flex justify-between items-center mb-1.5">
                    ...
                    <span className="text-[10px] px-2 py-0.5 bg-green-500/10 text-green-400 font-medium rounded-full">Perfect Match</span>
                  </div>
                  <p className="text-[11px] text-slate-500">Official recommendation for production apps.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <section className="bg-bg-panel rounded-xl border border-border-main shadow-sm">
            ...
            <div className="p-5 space-y-8">
              <div>
                <div className="flex justify-between items-end mb-2">
                  <div className="flex flex-col">
                    <span className="text-xs font-bold text-white uppercase">Popularity</span>
                    <span className="text-[10px] text-slate-500">Stars, Forks, Watchers</span>
                  </div>
                  <span className="text-lg font-mono font-bold text-white">24<span className="text-sm text-slate-500">/25</span></span>
                </div>
                ...
                <div className="flex gap-4 text-xs text-slate-500 font-mono border-t border-dashed border-slate-700 pt-2">
              ...
              <div>
                <div className="flex justify-between items-end mb-2">
                  <div className="flex flex-col">
                    <span className="text-xs font-bold text-white uppercase">Activity</span>
                    <span className="text-[10px] text-slate-500">Commits, PR Velocity</span>
                  </div>
                  <span className="text-lg font-mono font-bold text-white">22<span className="text-sm text-slate-500">/25</span></span>
                </div>
                <div className="w-full bg-slate-800 rounded-sm h-4 mb-3 relative overflow-hidden">
                ...
                <div className="bg-green-500/10 border border-green-500/20 rounded p-3 flex gap-3 items-start">
                  ...
                  <div>
                    <p className="text-xs text-green-400 font-bold mb-0.5">High Velocity</p>
                    <p className="text-[11px] text-green-300/70 leading-snug">Last release 4d ago. This project moves fast.</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                <div className="flex justify-between items-end mb-2">
                  <div className="flex flex-col">
                    <span className="text-xs font-bold text-white uppercase">Maintenance</span>
                    <span className="text-[10px] text-slate-500">Issue Closure, Stale Bots</span>
                  </div>
                  <span className="text-lg font-mono font-bold text-white">16<span className="text-sm text-slate-500">/20</span></span>
                </div>
                <div className="w-full bg-slate-800 rounded-sm h-4 mb-3 relative overflow-hidden">
                ...
                <div className="bg-amber-500/10 border border-amber-500/20 rounded p-3 flex gap-3 items-start">
                  ...
                  <div>
                    <p className="text-xs text-amber-400 font-bold mb-0.5">Improvement Hint</p>
                    <p className="text-[11px] text-amber-300/70 leading-snug">Close ratio on issues dipped below 80%.</p>
                  </div>
                </div>
              </div>
            </div>
